...
List<TestModal> testModalFromJson(String str) =>
    List<TestModal>.from(json.decode(str).map((x) => TestModal.fromJson(x)));

String testModalToJson(List<TestModal> data) =>
...
class TestModal {
  ...
  factory TestModal.fromJson(Map<String, dynamic> json) => TestModal(
